...
filename = file.path(model.directory, 
                     paste0("ABU_model_conditional_chains_", as.character(nChains),
                            "_samples_",as.character(samples),
                            "_thin_",as.character(thin),".rda"))
load(filename)

# convert to coda object
mpost = convertToCodaObject(ABU_model_conditional, 
...
# there are 509 species-covariate pairs with low ESS (<100) for beta. this is a 
...
# moderate for the beta parameters and poor for the omega and gamma parameters
# of the conditional abundance model. reliable parameter estimates and variance
...
ggsave(plot = last_plot(),
       filename = here("Figures", "ABU_Model",
                       "Beta_Trace_Random_Sample_4Chains_1200Samples_100Thin.jpg"),
...
ggsave(plot = last_plot(),
       filename = here("Figures", "ABU_Model",
                       "Beta_Trace_A_septemfasciatus_4Chains_1200Samples_100Thin.jpg"),
       width = 8, height = 10, units = "in", dpi = 300)
...
ggsave(plot = last_plot(),
       filename = here("Figures", "ABU_Model",
                       "Beta_Trace_A_triostegus_4Chains_1200Samples_100Thin.jpg"),
       width = 8, height = 10, units = "in", dpi = 300)
...
ggsave(plot = last_plot(),
       filename = here("Figures", "ABU_Model",
                       "Beta_Trace_S_altipinnis_4Chains_1200Samples_100Thin.jpg"),
       width = 8, height = 10, units = "in", dpi = 300)
